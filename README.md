...
* **Dataset Crudo:** [Ver datos_sensores_planta.csv](./datos_sensores_planta.csv) (Archivo en formato CSV generado sintéticamente que contiene la telemetría base de velocidad y temperatura con ruido estructural para el entrenamiento).
